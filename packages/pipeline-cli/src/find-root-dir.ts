 ...
 * (the decisions-index the originating work item fix). It lived in the now-removed `doc-links` tool
 * (the first tool to need it); relocated here as a cross-tool primitive (the originating work item).
 */
