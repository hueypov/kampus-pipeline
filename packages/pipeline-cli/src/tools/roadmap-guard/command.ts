 ...
 * ruling (roadmap map the originating work item, founder the originating work item). Parses ROADMAP.md's `## Arcs`/`## Campaigns`
 ...
 * one active arc; I3 no unclaimed open milestone; I4 fail-closed on zero scope (the zero-scope fail-closed invariant);
 * I5 active↔done state symmetry — an active row's milestone is open, a done row's closed
 * (the campaign lifecycle guard, the originating work item).
 *
 ...
 * platform union (the registry seam, the originating initiative).
 *
