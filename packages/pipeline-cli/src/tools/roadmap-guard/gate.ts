 ...
 * zero-scope fail-closed (the zero-scope fail-closed invariant). An IO/`gh` failure is a distinct typed error (also
 ...
 * lifecycle symmetry, the originating work item). Succeeds only on a passing verdict; every non-pass —
