/**
 * `worktree-guard assert-clean` decision core — the fail-closed clean-tree assertion (the originating work item).
 *
 * LAYER 2 containment for the worktree-corruption class: a freshly provisioned worktree is
 * *supposed* to come up pristine, but the originating work item caught one that came up dirty (an unauthored
