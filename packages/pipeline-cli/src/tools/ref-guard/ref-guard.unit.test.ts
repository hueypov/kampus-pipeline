...
// the originating work item mechanical half: a bare HEAD-detaching checkout on the shared PRIMARY checkout is
...
describe("decideHeadDetach — bare HEAD detach on the primary (the #2270 refuse)", () => {
	...
	// paired branch ⇒ detach) false-refused this legitimate PULLER reattach — the documented failure regression.
