/**
 * Pure-core tests for `settings-env-guard` (the originating work item): reds on any env value carrying
...
const PATH_VALUE = `${brace("CLAUDE_PROJECT_DIR")}/tools:/usr/bin:${brace("PATH")}`;
...
describe("judge — red on any unexpanded brace token in an env value", () => {
	...
	it("FAILS on the #2495 PATH value containing a literal brace token", () => {
