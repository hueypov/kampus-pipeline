 ...
 * filesystem-seam test (the originating work item, the descriptive/normative design firewall). The pure parse/verdict/firewall-predicate is
...
describe("writeDescriptiveArtifact — the descriptive/normative firewall (AC 3, the descriptive/normative design firewall)", () => {
