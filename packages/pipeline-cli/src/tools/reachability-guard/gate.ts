/**
 * The `reachability-guard` filesystem gate (the feature reachability requirement) — the IO seam behind the
 ...
 * flag definitions (fail-closed, the zero-scope fail-closed invariant). A directory/file IO failure is an `IoError`
 ...
 * an unknown flag key (the zero-scope fail-closed invariant / 0173 §1).
 */
