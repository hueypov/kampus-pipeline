/**
 * The `ship-digest` tool — `pipeline-cli ship-digest derive` (the originating work item).
 *
 ...
 *
 * Untrusted entries JSON is decoded into `ShipEntry[]` at this boundary, and everything downstream is
