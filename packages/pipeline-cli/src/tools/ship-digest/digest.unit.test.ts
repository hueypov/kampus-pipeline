...
describe("resolveSection — PR signal preferred, join fallback (the originating work item)", () => {
...
describe("resolveReleaseState — merged-vs-live-to-users axis (the authoritative live-state source)", () => {
