 ...
 * the exact failure mode of the stale README this replaces (the originating work item).
 *
 ...
 * `id · title · status` ambient-discovery surface (the on-demand decision-discovery rule). A tool missing a
