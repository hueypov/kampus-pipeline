/**
 * `checkFanout` over a fake repo dir — the filesystem-seam test (the declared mutation-publication guard, the originating work item,
 * the originating work item). The pure verdict (drift, missing-publish, zero-scope, topic-mismatch) is
