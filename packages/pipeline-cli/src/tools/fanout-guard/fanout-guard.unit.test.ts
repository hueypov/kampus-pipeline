/**
 * Pure-core tests for `fanout-guard` (the declared mutation-publication guard, the related failure modes): the drift check (a
 ...
 * fail-closed-on-zero verdict (the zero-scope fail-closed invariant), and the manifest/mutation-key/publisher/
