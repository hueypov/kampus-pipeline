 ...
 * the originating work item). Two live surfaces:
 *
 ...
 *
 * `check` (the originating work item) validates the on-disk corpus format. `report` (the originating work item) is the
 ...
 * decision (the originating work item) consumes. It presents measurement, never a recommendation.
 *
