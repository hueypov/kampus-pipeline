 ...
 * per-stage ground truth (the originating work item, the originating initiative).
 *
 * The token-economics apparatus (the measured no-quality-regression methodology) grades one frozen input per stage with a
 ...
 * *corpus* per stage, the graded generalization of the measured no-quality-regression methodology §1's single frozen input
 * into a version-controlled ground truth. See the measured no-quality-regression methodology.
 *
...
/** A reproducible input identifier — an issue/PR number (the measured no-quality-regression methodology §1: pinned by identifier). */
