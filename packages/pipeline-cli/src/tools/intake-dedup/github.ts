...
const resolveRepo = Effect.fn("Github.resolveRepo")(function* () {
	...
	const viewed = yield* runGh([
		...
		Effect.catchTag("intake-dedup/GhCommandError", () => Effect.succeed("")),
	);
 ...
 * Repo resolution is deferred to first use (`Effect.cached`, the repository-resolution contract §1): the layer build is
