/**
 * The pure match core for `intake-dedup` (the unified deterministic intake-dedup rule): the "is there already an open
 ...
 * function words ("bir", "için", "gibi") through as false keywords (the originating work item). Kept deliberately
