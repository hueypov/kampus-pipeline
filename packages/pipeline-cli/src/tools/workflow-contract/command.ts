 ...
 *
 * The CI surface for the Workflow-script contract gate (the originating work item). Bug the originating work item was a
 ...
 *
 * Fail-closed (the zero-scope fail-closed invariant): a present-but-unparseable or violating script reds; an
