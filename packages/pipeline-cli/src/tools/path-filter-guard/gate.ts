/**
 * The `path-filter-guard` filesystem gate (the originating work item) — the IO seam behind the
 ...
 * key or an empty list — fail-closed, the zero-scope fail-closed invariant). A file that cannot be read is an
 ...
 * zero-scope gap (the zero-scope fail-closed invariant).
 */
