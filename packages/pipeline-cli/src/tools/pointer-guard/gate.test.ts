 ...
 * test (the related failure modes). The pure extraction/precision logic is covered in
...
describe("checkPointers", () => {
	...
	it("fails CheckFailed (fail-closed, the zero-scope fail-closed invariant) when zero CLAUDE.md are in scope", async () => {
