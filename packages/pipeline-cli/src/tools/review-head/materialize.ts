 ...
 * the review-code / review-doc / review-skill gates each hand-copied inline (the originating work item / the originating work item), and the
 ...
 * (`Effect.cached`, the repository-resolution contract §1) so the layer build is side-effect-free.
 */
