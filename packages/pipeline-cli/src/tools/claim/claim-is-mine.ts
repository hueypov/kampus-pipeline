 ...
 * the authenticated, session-stamped claim protocol §2 / gh-issue-intake-formats.md §7) rather than shipping a second copy —
 * the AC of the originating work item — and adds one projection on top: **default-deny**. Only a `won`
 ...
 * expensive-but-correct path rather than mutating on an unproven claim (the documented failure
