 ...
 * [--plan-file <f>]`.
 *
 * The deterministic epic-body splice `plan-epic` Step 5 used to hand-compose inline (the originating work item / the originating work item):
 ...
 * skill prose (the originating work item scope).
 */
