 ...
 * epic-body splice (the originating work item), extracted from the ~95-line hand-composed splice the
 * skill's Step 5 carried inline (the originating work item). Given the live epic body, a freshly-derived
 ...
 * they are IO against the live GitHub issue, not a text function (the originating work item scope).
 *
 ...
 * (or any other section) can never be clobbered by this write (the originating work item, the lost-update
