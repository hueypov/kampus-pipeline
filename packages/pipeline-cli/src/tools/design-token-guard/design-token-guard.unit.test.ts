/**
 * The pure `design-token-guard` core — parsers + `judge` (the originating work item). Deterministic
...
describe("judge — scope + reporting", () => {
	it("FAILS closed on zero CSS files (the zero-scope fail-closed invariant)", () => {
