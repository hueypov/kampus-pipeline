/**
 * Pure-core tests for `roadmap diagram` (#187): the `## Dependencies` table parse, the
 ...
 *
 * The table rows below are synthetic fixture INPUT carried over from the port — `#3642`,
 * `ADR 0202` and the arc names are strings fed to the parser to exercise external-endpoint
 * slugging, not references to any artifact in this repository. Changing them would mean
 * restating every expected slug for no gain.
 */
