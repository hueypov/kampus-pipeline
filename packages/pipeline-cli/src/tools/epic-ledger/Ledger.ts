 ...
 * forcing-function check (the real-consumer requirement); `"none"`/`undefined` is the unset state.
 */
 ...
 * cycle doc (the real-consumer requirement).
 */
 ...
 * of data. It gates the `MISSING_CONTAINMENT` check (the real-consumer requirement): a `type:feature`
