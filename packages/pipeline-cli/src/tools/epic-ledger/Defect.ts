 ...
 * the floor's zero-scope=fail self-assertion (formats §ZS / the zero-scope fail-closed invariant) — an epic
 ...
 * `ZERO_AC`) — the two halves of the story-coverage invariant: every declared story
 ...
 * repo that has a cycle doc (the real-consumer requirement, formats §2). It sits in the child-content
