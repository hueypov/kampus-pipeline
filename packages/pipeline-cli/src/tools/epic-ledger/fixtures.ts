 ...
 * what it varies. Plain TypeScript data, with no Effect runtime.
 */
...
export const epic = (overrides: Partial<EpicHeader> = {}): EpicHeader => ({
	number: 100,
	title: "the originating initiative",
...
export const ledger = (overrides: Partial<EpicLedger> = {}): EpicLedger => ({
	...
	children: [],
	externalRefs: [],
	// Default to a example-repo-like repo that HAS a cycle doc, so MISSING_CONTAINMENT is
