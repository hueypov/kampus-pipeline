 ...
 * DENYLIST into an ENFORCED ALLOWLIST (the originating work item, residual from the related failure modes).
 *
 * The roster-law boundary keeps a read-only fanout from drifting into a
 ...
 *
 * Fail-closed by construction (the zero-scope fail-closed invariant): zero roster / zero bridges, a missing bridge
