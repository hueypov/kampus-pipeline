 ...
 *
 * The pure, default-deny crash classifier (the originating initiative, the child work item). Prints the class
 ...
 * sibling the originating work item. It ships correct, tested, and dormant.
 *
...
export const failureClassifierCommand = Command.make("failure-classifier").pipe(
	...
	Command.withDescription(
		"Pure default-deny crash classifier: TRANSIENT vs LOGIC for crashed dynamic workflows (the originating initiative)",
	),
);
