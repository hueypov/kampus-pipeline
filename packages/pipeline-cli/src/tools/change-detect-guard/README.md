...
[the originating work item](https://github.com/example-org/example-repo/issues/3245)).
...
aggregate went **RED on a defect-free docs-only PR** ([the originating work item](https://github.com/example-org/example-repo/pull/3244)).
...
or a missing `with:` block is a FAILURE — a guard that could not locate the step to
check is broken, never a vacuous pass.
