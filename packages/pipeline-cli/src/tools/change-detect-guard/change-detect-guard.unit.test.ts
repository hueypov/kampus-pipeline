/**
 * The pure `change-detect-guard` verdict (the originating work item), over crafted ci.yml text — no disk. The
 ...
 * token that reopens that path proves the documented failure/the originating work item flake surface stays closed.
 */
