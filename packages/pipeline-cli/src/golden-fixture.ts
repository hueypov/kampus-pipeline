/**
 * Golden real-payload fixture loader (the captured-runtime-artifact rule).
 *
 ...
 * fixture — never a hand-authored shape (that is exactly how the originating work item shipped a hook built to
...
/** Read a committed golden real-payload fixture verbatim (the raw JSON text). the captured-runtime-artifact rule. */
