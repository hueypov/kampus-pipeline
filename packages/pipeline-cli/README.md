...
The command-line toolbox for the [kamp.us](https://github.com/example-org/example-repo) agent
...
The source lives in the example-repo monorepo under
[`packages/pipeline-cli/`](https://github.com/example-org/example-repo/tree/main/packages/pipeline-cli).
