...
describe("crew/tracker — acquireClaim + release (the claim lifecycle client, the safe-release rule: only the claim holder may release it, and releasing a missing claim is a no-op)", () => {
