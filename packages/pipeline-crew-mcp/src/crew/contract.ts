/**
 * crew/contract — the crew composition of the discoverable channel contract (the message-schema contract): the generic
...
/**
 * Resolve the full discoverable channel contract, or fail loud — the startup invariant (the message-schema contract). The
