/**
 * The crew composition of the discoverable channel contract (the message-schema contract): each role's sanctioned seams
...
describe("crew/contract — the discoverable role↔kind surface (the message-schema contract)", () => {
