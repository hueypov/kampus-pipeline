 ...
 * `../index.ts`.
 *
 * Two directions, wired to a peer at the crew root (the composition-boundary rule: generic channel edges consume ports while the crew root owns peer construction):
