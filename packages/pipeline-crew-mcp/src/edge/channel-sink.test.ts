 ...
 * `ServerNotificationRpcs` member ONLY under the effect patch (the local dependency-patch rule: rely on released dependencies or committed local pnpm patches, never forks, git URLs, or unmerged upstream work) — so emitting it
