/**
 * The discovery tool (the message-schema contract): the channel edge server lists a `channel_kinds` tool and a `tools/call`
...
describe("edge/kinds-tool — the channel_kinds discovery tool (the message-schema contract)", () => {
