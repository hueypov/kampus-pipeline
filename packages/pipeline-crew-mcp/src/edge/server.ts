 ...
 * (the composition-boundary rule: generic channel edges consume ports while the crew root owns peer construction) — this layer requires the `ChannelSend` port (the peer's send capability) and
