 ...
 * `RpcClient` — the real one dials the peer's socket (the composition-boundary rule: generic channel edges consume ports while the crew root owns peer construction), a test one is in-memory. A
