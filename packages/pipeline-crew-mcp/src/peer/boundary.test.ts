 ...
 * crew role catalog + wiring is the `crew/` composition root (the composition-boundary rule: generic channel edges consume ports while the crew root owns peer construction). Mirrors the same
