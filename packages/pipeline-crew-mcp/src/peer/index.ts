 ...
 * its role lease for the connection lifetime (connection-is-lease, the role-addressing rule: send to a role inbox, and treat delivery as queued rather than read); a send to an
 ...
 * noun. The concrete role catalog + wiring is the `crew/` composition root (the composition-boundary rule: generic channel edges consume ports while the crew root owns peer construction).
 */
