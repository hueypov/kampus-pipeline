/**
 * The project-scope registrar (the channel-probe rule: distinguish a connected server, a brief boot delay, and a persistent failure): the pure config transforms, the per-pane `.mcp.json` emission +
