...
# human, NOT an active repair. Author-gate the FAIL markers to write+ collaborators (the authorization rule that accepts privileged actions only from repository members) and
