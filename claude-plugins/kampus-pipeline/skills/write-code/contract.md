...
#53. The session dimension (one account, two sessions, one of which built the PR) is a **residual
hole**, tracked separately: this closes the account dimension, which is the one that is always
readable.
